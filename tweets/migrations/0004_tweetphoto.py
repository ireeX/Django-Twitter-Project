# Generated by Django 3.1.14 on 2021-12-28 03:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'index_together': {('status', 'created_at'), ('tweet', 'order'), ('user', 'created_at'), ('is_deleted', 'created_at')},
            },
        ),
    ]
